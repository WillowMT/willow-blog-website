    ...
    return (
        ...
        <footer className="text-gray-600 body-font bg-white">
            ...
            >
                ...
                >
                    <div
                        className="w-10 h-10 rounded-full bg-blue-300 text-white text-3xl text-center grid place-items-center"
                    >
                        W
                    </div>
                    <span className="ml-3 text-xl">Willow</span>
                </a>
                <p
